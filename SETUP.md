...
Кодовое слово, необходимое при регистрации, смотрите в [lms](https://lk.dataschool.yandex.ru/courses/2025-autumn/7.1556-iazyk-python/).
...
$ git clone git@gitlab.manytask.org:python/students-2025-fall/<твой ник в manytask>
...
$ git remote add upstream git@gitlab.manytask.org:python/public-2025-fall.git
```
